const styles = {
    ...
    shop_name:"pt-3 text-[15px] text-gray-500 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'p-2 bg-white h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#169CC2] flex items-center justify-center cursor-pointer",
